...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20240807090840_addAboutLanguage")]
    partial class addAboutLanguage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntityLayer.Concrete.GalleryTranslation", b =>
                {
                    b.Property<int>("GalleryTranslationID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("GalleryTranslationID"));
                    ...
                    b.HasKey("GalleryTranslationID");

                    b.HasIndex("GalleryID");

                    b.ToTable("GalleryTranslations");
                });
            ...
            modelBuilder.Entity("EntityLayer.Concrete.ArgeTranslation", b =>
                {
                    ...
                    b.HasOne("EntityLayer.Concrete.Gallery", null)
                        .WithMany("GalleryTranslations")
            ...
            modelBuilder.Entity("EntityLayer.Concrete.Gallery", b =>
                {
                    b.Navigation("GalleryTranslations");
                });
